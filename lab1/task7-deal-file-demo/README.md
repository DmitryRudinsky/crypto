...
### 3. Шифрование медиафайлов
- **Изображения (PNG)**: тестовое изображение ~1 КБ, режим CTR
- **Аудио (MP3)**: тестовый аудиофайл ~8 КБ, режим CBC
- **Видео (MOV)**: тестовое видео ~16 КБ, режим OFB
- Измерение времени шифрования и дешифрования
- Проверка целостности восстановленных файлов

### 4. Сравнение режимов шифрования
...
│   ├── test_image.png.enc            # Зашифрованное изображение
│   ├── test_audio.mp3                # Тестовое аудио
│   ├── test_audio.mp3.enc            # Зашифрованное аудио
│   ├── test_video.mov                # Тестовое видео
│   └── test_video.mov.enc            # Зашифрованное видео
